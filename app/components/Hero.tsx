...
export default function Hero(){
    return (
        <div className="bg-gradient-to-b from-black to-blue-900 min-h-screen h-auto flex flex-col justify-center items-center pb-12">
            <StarPattern />
            <GreenStar />
            <BlueStar />
            <div className='mt-[120px] text-center max-w-4xl px-[24px] sm:px-[64px] md:px-[96px]'>
